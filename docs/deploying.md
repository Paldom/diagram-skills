...
- Consumers run `npx skills add Paldom/diagram-skills` — the CLI
  ...
  users can also `gh skill install Paldom/diagram-skills <skill>
...
gh repo edit Paldom/diagram-skills --visibility public --accept-visibility-change-consequences
...
gh api repos/Paldom/diagram-skills/private-vulnerability-reporting --method PUT
gh repo edit Paldom/diagram-skills --enable-secret-scanning
gh repo edit Paldom/diagram-skills --enable-secret-scanning-push-protection

# 3. Cut a versioned release (matches .claude-plugin/plugin.json) + topics
gh skill publish --tag v0.1.0
gh repo edit Paldom/diagram-skills --add-topic skills-sh
#    (gh < 2.90 has no `gh skill`; equivalent fallback:
#     gh release create v0.1.0 --generate-notes
#     gh repo edit Paldom/diagram-skills --add-topic agent-skills --add-topic skills-sh)
...
npx skills@latest add Paldom/diagram-skills --list
mkdir -p /tmp/skills-verify && cd /tmp/skills-verify
env -u DISABLE_TELEMETRY -u DO_NOT_TRACK npx skills@latest add Paldom/diagram-skills -a claude-code -y   # NO --skill '*': the wildcard opts into internal dev skills
...
curl -sIL https://skills.sh/Paldom/diagram-skills | head -1
```
...
(`https://skills.sh/b/Paldom/diagram-skills`) linking to the repo's
